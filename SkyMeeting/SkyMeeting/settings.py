...
DATABASES = {
    'default': {
        ...
        'NAME': 'skymeeting',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '*5!&rr#3^z_^$xi0)yu06qmdrfpf)$)5!)&wmyw*g%pcl3-mum'
...
ROOT_URLCONF = 'SkyMeeting.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'SkyMeeting.wsgi.application'
