...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.close_time'
        db.alter_column('Meeting', 'close_time', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='close_time'))

        # Changing field 'Meeting.contact_email'
        db.alter_column('Meeting', 'contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, db_column='contact_email'))

        # Changing field 'Meeting.contact_tel'
        db.alter_column('Meeting', 'contact_tel', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, db_column='contact_tel'))

    def backwards(self, orm):

        # Changing field 'Meeting.close_time'
        db.alter_column('Meeting', 'close_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 26, 0, 0), db_column='close_time'))

        # Changing field 'Meeting.contact_email'
        db.alter_column('Meeting', 'contact_email', self.gf('django.db.models.fields.EmailField')(default='null@null.com', max_length=75, db_column='contact_email'))

        # Changing field 'Meeting.contact_tel'
        db.alter_column('Meeting', 'contact_tel', self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_column='contact_tel'))
