...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TempRole.verifyByPhone'
        db.delete_column('TempRole', 'VerifyModePhone')

        # Adding field 'TempRole.verifyByIdCard'
        db.add_column('TempRole', 'verifyByIdCard',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='VerifyModeIdCard'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TempRole.verifyByPhone'
        db.add_column('TempRole', 'verifyByPhone',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_column='VerifyModePhone'),
                      keep_default=False)

        # Deleting field 'TempRole.verifyByIdCard'
        db.delete_column('TempRole', 'VerifyModeIdCard')
    ...
    models = {
        ...
        u'MemManage.temprole': {
            ...
            'verifyByIdCard': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_column': "'VerifyModeIdCard'"}),
